...
//                 <div className="mt-4">
//   <div className="flex items-center justify-between bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg px-3 py-2 text-white text-xs font-medium shadow-sm">
//     <span className="flex items-center gap-1">
...
//       className="flex-1 text-center py-2 rounded-lg bg-gradient-to-r from-sky-500 to-blue-600 text-white text-sm font-medium shadow-md hover:opacity-90 transition-all"
//     >
//       Update
//     </Link>
...
//       className="flex-1 text-center py-2 rounded-lg bg-gradient-to-r from-red-500 to-pink-600 text-white text-sm font-medium shadow-md hover:opacity-90 transition-all"
//     >
//       Delete
//     </Link>
//   </div>
